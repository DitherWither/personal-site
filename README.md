...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zly48tm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zly48tm.containers.anotherwebservice.com/
...
```
git clone git@github.com:DitherWither/personal-site.git
cd container-zly48tm
```
...
```
docker attach container-zly48tm
```
